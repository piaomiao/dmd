...
Route::group('api', function () {
    ...
    Route::group(function () {
        ...
        Route::get('test', 'v1.PublicController/test')
            ->name('test');
    ...
    Route::group(function () {
        ...
        Route::post('upload/video', 'v1.PublicController/upload_video')->name('uploadVideo'); //视频上传
        Route::post('upload/get_temp_keys', 'v1.PublicController/get_temp_keys')->name('getTempKeys'); //视频上传
        //用户类 客服聊天记录
        ...
        Route::get('user/shares', 'v1.user.UserController/shares')->name('shares'); //用户股份
        ...
        Route::get('divide', 'v1.user.UserBrokerageController/divide')->name('divide'); //股东分成数据 昨天的分成 累计提现金额 当前分成
    ...
    Route::group('v2', function () {
        ...
        Route::group(function () {
            ...
            //获取用户推广用户列表
            Route::get('shareholder/shareholder_user_list/:type', 'v2.shareholder.ShareholderController/shareholderUserList')->name('agentUserList');
            //获取股东获得收益，佣金轮播，分销规则
            Route::get('shareholder/shareholder_info', 'v2.shareholder.ShareholderController/shareholderInfo')->name('shareholderInfo');
            //拼单接口
            //验证是否在配送范围
    ...
    Route::group('admin', function () {
        ...
        //视频
        Route::get('video/index', 'v1.admin.video.Video/index')->name('videoIndex'); 
        Route::post('video/save/:id', 'v1.admin.video.Video/save')->name('videoSave');
        Route::get('video/detail/:id', 'v1.admin.video.Video/detail')->name('videoDetail');
        Route::post('video/delete/:id', 'v1.admin.video.Video/delete')->name('videoDelete');
        Route::post('video/set_show/:id/:status', 'v1.admin.video.Video/set_show')->name('videoSetShow');
        Route::get('video/product', 'v1.admin.video.Video/product')->name('videoSetShow');

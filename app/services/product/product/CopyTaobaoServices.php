...
class CopyTaobaoServices extends BaseServices
{
    ...
    public function save(array $data)
    {
        ...
        //开始图片下载处理
        $this->transaction(function () use ($attrs, $detail, $data, $AttachmentCategory, $storeCategoryServices, $storeProductServices, $storeDescriptionServices, $storeProductRelationServices, $storeProductAttrServices, $storeProductCouponServices, $relationData) {
            //放入主图
            $images = [
            ...
            if ($productInfo) {
				...
				$storeProductRelationServices->change($res['id'], $cateData);

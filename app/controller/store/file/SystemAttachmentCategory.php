...
class SystemAttachmentCategory extends AuthController
{
    ...
    public function create($id)
    {
        ...
        return app('json')->success($this->service->createForm($id, 2, $this->storeId, (int)$file_type));
    }
    ...
    public function edit($id)
    {
        ...
        return app('json')->success($this->service->editForm($id, 2, $this->storeId, (int)$file_type));
    }
